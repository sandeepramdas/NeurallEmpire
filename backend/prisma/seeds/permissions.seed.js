...
exports.prisma = exports.DEFAULT_ROLES = exports.PERMISSIONS = void 0;
...
exports.DEFAULT_ROLES = [
    {
        ...
        isDefault: false,
        priority: 100,
        permissions: exports.PERMISSIONS.map(p => p.code),
    },
    {
        code: 'ADMIN',
        name: 'Administrator',
        ...
        isDefault: false,
        priority: 90,
        permissions: exports.PERMISSIONS.filter(p => !p.code.includes('settings:update:billing') &&
            !p.code.includes('settings:update:organization')).map(p => p.code),
    },
    {
        code: 'ACCOUNTANT',
        name: 'Accountant',
...
async function seedPermissionsAndRoles() {
    ...
    try {
        ...
        console.log(`✅ Created ${exports.PERMISSIONS.length} permissions`);
        console.log('✅ Permissions seeded successfully');
        console.log('💡 Roles will be created per-organization during setup');
        return { permissions: exports.PERMISSIONS.length, roles: exports.DEFAULT_ROLES.length };
    }
    catch (error) {
