...
export const MENU_ITEMS = [
  ...
  // ===== ORCHESTRATOR =====
  {
    ...
    badge: 'New',
    badgeColor: 'blue',
    permissionsRequired: ['orchestrator:read'],
    rolesRequired: [],
    children: [
      {
        ...
        route: '/orchestrator/tools',
        component: 'OrchestratorTools',
        orderIndex: 1,
        showInSidebar: true,
        isActive: true,
        permissionsRequired: ['orchestrator:read'],
      ...
      },
      {
        ...
        component: 'OrchestratorWorkflows',
        orderIndex: 2,
        showInSidebar: true,
        isActive: true,
        permissionsRequired: ['orchestrator:read'],
      ...
      {
        name: 'orchestrator-collaborations',
        label: 'Multi-Agent Teams',
        icon: 'UserGroupIcon',
        route: '/orchestrator/collaborations',
        component: 'OrchestratorCollaborations',
        orderIndex: 3,
        showInSidebar: true,
        isActive: true,
        badge: 'Elite',
      ...
      {
        name: 'orchestrator-schedules',
        label: 'Scheduling',
        icon: 'CalendarIcon',
        route: '/orchestrator/schedules',
        component: 'OrchestratorSchedules',
        orderIndex: 4,
        showInSidebar: true,
        isActive: true,
        permissionsRequired: ['orchestrator:read'],
      ...
      {
        name: 'orchestrator-marketplace',
        label: 'Marketplace',
        icon: 'ShoppingCartIcon',
        route: '/orchestrator/marketplace',
        component: 'OrchestratorMarketplace',
        orderIndex: 5,
        showInSidebar: true,
        isActive: true,
        permissionsRequired: ['orchestrator:read'],
      ...
      },
      {
        ...
        component: 'OrchestratorPermissions',
        orderIndex: 6,
        showInSidebar: true,
        isActive: true,
        permissionsRequired: ['orchestrator:admin'],
        rolesRequired: ['ADMIN', 'OWNER'],
      },
    ],
  },
