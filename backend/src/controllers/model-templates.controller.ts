...
const MODEL_TEMPLATES: ModelTemplate[] = [
  ...
  },
  {
    ...
    name: 'GPT-4o Mini',
    category: 'AI Models',
    description: 'Ultra-efficient mini model optimized for low-latency, high-speed inference with minimal resource usage and cost',
    icon: '⚡',
    color: '#10b981',
    ...
    supportedTasks: ['quick-responses', 'real-time-chat', 'edge-inference', 'fast-analysis', 'lightweight-tasks', 'vision-tasks'],
    tags: ['gpt-4o', 'mini', 'fast', 'efficient', 'edge', 'lightweight', 'real-time', 'cost-effective'],
