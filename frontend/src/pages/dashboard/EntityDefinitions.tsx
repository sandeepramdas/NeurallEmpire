        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`p-2 rounded-lg ${viewMode === 'grid' ? 'bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-200' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300'}`}
            >
              <Grid3x3 className="w-5 h-5" />
            </button>
            <button
              onClick={() => setViewMode('list')}
              className={`p-2 rounded-lg ${viewMode === 'list' ? 'bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-200' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300'}`}
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Total Entities</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{entities.length}</p>
            </div>
            <Database className="w-8 h-8 icon-active" />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 dark:text-gray-400 text-sm">System Entities</p>
                      ...
                      <div className="p-6">
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h3 className="font-semibold text-gray-900 dark:text-gray-100">{entity.displayName}</h3>
                              <p className="text-sm text-gray-500 dark:text-gray-400">{entity.entityName}</p>
                            </div>
                          </div>
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          ...
                          {entity.tags.slice(0, 2).map((tag) => (
                            <span key={tag} className="px-2 py-1 text-xs bg-gray-100 text-gray-700 dark:text-gray-300 rounded">
                              {tag}
                            </span>
                          ))}
                        </div>
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="flex-1 px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 dark:text-gray-300 flex items-center justify-center gap-2"
                          >
                  ...
                  <table className="w-full">
                    <thead className="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                      <tr>
                        ...
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Vertical</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Columns</th>
                        ...
                        <tr key={entity.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-3">
                              {getCategoryIcon(entity.category)}
                              <div>
                                <div className="font-medium text-gray-900 dark:text-gray-100">{entity.displayName}</div>
                                <div className="text-sm text-gray-500 dark:text-gray-400">{entity.entityName}</div>
                              </div>
                            </div>
                          </td>
                          <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">{entity.vertical || '-'}</td>
                          ...
                          <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">v{entity.version}</td>
                          <td className="px-6 py-4 text-right">
                            <div className="flex items-center justify-end gap-2">
                              <button
                                ...
                                className="p-2 text-gray-600 dark:text-gray-400 hover:text-blue-600 hover:bg-blue-50 dark:bg-blue-900/20 rounded-lg"
                              >
                                <Eye className="w-4 h-4" />
                              </button>
                              {entity.status === 'draft' && !entity.isSystemEntity && (
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Create New Entity</h2>
              <button
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-6">
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{selectedEntity.displayName}</h2>
                <button
            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <p className="mt-1 text-gray-900 dark:text-gray-100">{selectedEntity.entityName}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Table Name</label>
                  <p className="mt-1 text-gray-900 dark:text-gray-100 font-mono text-sm">{selectedEntity.tableName}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-900 dark:text-gray-100">v{selectedEntity.version}</p>
                </div>
              </div>
              ...
              {selectedEntity.description && (
                <div className="mb-6">
                  ...
                  <p className="mt-1 text-gray-900 dark:text-gray-100">{selectedEntity.description}</p>
                </div>
              )}

              <div className="mb-6">
                <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block">Schema</label>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-gray-200 dark:border-gray-700">
                        <th className="text-left py-2 text-sm font-medium text-gray-700 dark:text-gray-300">Column</th>
                        <th className="text-left py-2 text-sm font-medium text-gray-700 dark:text-gray-300">Type</th>
                        <th className="text-left py-2 text-sm font-medium text-gray-700 dark:text-gray-300">Constraints</th>
                      </tr>
                    </thead>
                    <tbody>
                      {selectedEntity.schemaDefinition.columns.map((col, idx) => (
                        <tr key={idx} className="border-b border-gray-100 dark:border-gray-800 last:border-0">
                          <td className="py-2 text-sm font-mono text-gray-900 dark:text-gray-100">{col.name}</td>
                          <td className="py-2 text-sm text-gray-600 dark:text-gray-400">{col.type}</td>
