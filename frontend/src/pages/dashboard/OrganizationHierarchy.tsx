    ...
    return (
      <div className="relative">
        ...
        >
          ...
          {/* Level Badge */}
          <div className="flex-shrink-0">
            <span className="text-xs text-gray-500 font-mono">L{node.level}</span>
          </div>
        </div>
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm">Max Depth</p>
              <p className="text-2xl font-bold text-gray-900">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm">Subsidiaries</p>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm">Divisions</p>
            ...
            <div>
              <div className="flex items-start gap-3 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500">{selectedNode.slug}</p>
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-gray-900">{selectedNode.level}</p>
                </div>

                {selectedNode.description && (
                  <div>
                    <label className="text-sm font-medium text-gray-700">Description</label>
                    <p className="mt-1 text-gray-900">{selectedNode.description}</p>
                  </div>
                )}

                <div>
                  <label className="text-sm font-medium text-gray-700">Children</label>
                  <p className="mt-1 text-gray-900">{selectedNode.children.length}</p>
                </div>

                {selectedNode.userCount !== undefined && (
                  <div>
                    <label className="text-sm font-medium text-gray-700">Users</label>
                    <p className="mt-1 text-gray-900">{selectedNode.userCount}</p>
                  </div>
                )}
              </div>
