    ...
    <header className="bg-white dark:bg-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-40">
      <div className="px-6 py-3">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="relative hidden md:block">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-64 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-transparent transition-all"
              />
            </div>
            ...
            <button
              ...
              className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors hidden md:flex items-center space-x-1.5"
          ...
          {/* Right: Navigation & Utility Actions & User Menu */}
          <div className="flex items-center space-x-1">
            {/* Resources Mega Menu */}
            <div className="relative">
              <button
                onClick={() => setShowResourcesMenu(!showResourcesMenu)}
                className="px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center"
                title="Resources"
              >
                Resources
                <ChevronDown className={`w-4 h-4 ml-1 text-gray-500 dark:text-gray-400 transition-transform ${showResourcesMenu ? 'rotate-180' : ''}`} />
              </button>
              ...
              {showResourcesMenu && (
                <>
                  ...
                  />
                  <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 py-2 z-20">
                    <div className="px-4 py-2 border-b border-gray-100 dark:border-gray-700">
                      <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Resources</p>
                    </div>
                    <div className="py-2">
                      {resourcesMenuItems.map((item, index) => {
                        ...
                        return (
                          <a
                            ...
                            className="flex items-start px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group"
                            onClick={() => setShowResourcesMenu(false)}
                          >
                            <ItemIcon className="w-5 h-5 mr-3 icon-active mt-0.5" />
                            <div className="flex-1">
                              <div className="flex items-center">
                                <span className="text-sm font-medium text-gray-900 dark:text-gray-100 link-hover">{item.label}</span>
                                {item.external && <ExternalLink className="w-3 h-3 ml-1 text-gray-400 dark:text-gray-500" />}
                              </div>
            ...
            <div className="relative">
              ...
              >
                Help
                <ChevronDown className={`w-4 h-4 ml-1 text-gray-500 dark:text-gray-400 transition-transform ${showHelpMenu ? 'rotate-180' : ''}`} />
              </button>
              ...
              {showHelpMenu && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 py-2 z-20">
                    <div className="px-4 py-2 border-b border-gray-100 dark:border-gray-700">
                      <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Help & Support</p>
                    </div>
                    <div className="py-2">
                        ...
                        if (isAction) {
                          return (
                            <button
                              ...
                              className="w-full flex items-start px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group text-left"
                            >
                              <ItemIcon className="w-5 h-5 mr-3 icon-active mt-0.5" />
                              <div className="flex-1">
                                <span className="text-sm font-medium text-gray-900 dark:text-gray-100 link-hover block">{item.label}</span>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{item.description}</p>
                              </div>
                            </button>
                          );
            ...
            <div className="relative">
              <button
                ...
                title="User Menu"
              >
                <div className="w-8 h-8 avatar-gradient rounded-full flex items-center justify-center shadow-sm">
        ...
        <div className="flex items-center justify-between py-2 border-t border-gray-100 dark:border-gray-800">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                <div className="text-sm font-semibold text-gray-900 dark:text-gray-100">{organization?.name || 'Organization'}</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">{organization?.slug}.neurallempire.com</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 text-xs text-gray-600 dark:text-gray-400">
              <div className="flex items-center space-x-1">
                ...
                <span><span className="font-semibold text-gray-900 dark:text-gray-100">{organization?.maxUsers || 0}</span> users</span>
              </div>
              <div className="flex items-center space-x-1">
                <Database className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500" />
                <span><span className="font-semibold text-gray-900 dark:text-gray-100">0MB</span>/10GB</span>
              </div>
              <div className="flex items-center space-x-1">
                <Zap className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500" />
                <span><span className="font-semibold text-gray-900 dark:text-gray-100">0</span>/10k calls</span>
              </div>
            </div>
          </div>
